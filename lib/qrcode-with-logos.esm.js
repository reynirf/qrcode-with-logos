...
var convertToFile = function (image, name) {
    var dataURL = image.src;
...
var QrCodeWithLogo = (function () {
    ...
    QrCodeWithLogo.prototype.getFile = function (name) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2, convertToFile(this.option.image, name)];
                }
            });
        });
    };
